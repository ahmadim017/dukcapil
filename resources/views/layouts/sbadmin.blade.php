    ...
    <ul class="navbar-nav bg-gradient-info sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <li class="nav-item">
        ...
        <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
          ...
          <a class="collapse-item" href="{{route('halaman.index')}}">Master Halaman</a>
          </div>
        </div>
      </li>
      @endif
          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown no-arrow">
              <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                @if (\auth::user())
                <span class="mr-2 d-none d-lg-inline text-gray-600 small"><i class="fa-regular fa-user fa-beat text-gray-300" style="--fa-animation-duration: 2s;"></i> {{auth::user()->name}}</span>
                @endif
              </a>
