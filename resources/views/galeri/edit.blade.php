      ...
      @if(session('status'))
        ...
        <div class="row">
          <div class="col-6">
                ...
                <input type="text" name="judul" class="form-control {{$errors->first('judul') ? "is_invalid" : ""}}" value="{{$galeri->judul}}" required>
        ...
        <div class="row">
            <div class="col-12">
              ...
              <label for="">
                  <img src="{{asset('storage/app/public/'.$galeri->foto)}}" width="240px">
              </label>
        ...
        <div class="row">
            <div class="col-12">
                ...
                <input type="text" name="keterangan" cols="30" rows="10" value="{{$galeri->keterangan}}" class="form-control {{$errors->first('keterangan') ? "is-invalid" : ""}}">
